...
const Slide2 = ({ onNext, onPrev, onHome }) => {
  return (
    <div>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-4 sm:gap-8 p-4">
        ...
        <motion.div
          ...
          className="bg-slate-800/30 border border-slate-700 p-6 sm:p-10 rounded-3xl hover:border-secondary/50 transition-colors group"
        >
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-accent/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <Target className="text-secondary" size={32} />
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Resultado de Aprendizaje</h2>
        ...
        <motion.div
          ...
          className="bg-slate-800/30 border border-slate-700 p-6 sm:p-10 rounded-3xl hover:border-accent/50 transition-colors group"
        >
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-accent/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            <Users className="text-accent" size={32} />
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Población Objetivo</h2>
          <p className="text-slate-400 text-base sm:text-lg leading-relaxed">
